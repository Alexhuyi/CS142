  ...
  render() {
    return (
      <div className="container Example">
        ...
        <div className="cs142-example-motto">
            {/* Your problem #1 motto displaying and updating widget goes here */}
          <label htmlFor="motto">{this.state.name}&apos;s Motto: {this.state.motto}</label>
          <br></br>
          Change the motto:
          <input id="inId" type="text" value={this.state.motto} onChange={this.handleMottoChange} maxLength="20"/>
        </div>
        <p>
